...
Tutorial.resetSection3 = function() {
  ...
  var lang = document.language.current;
  if (lang.value === "en") {
    ...
    alert('Отлично, ваш код был запущен.\n\nПроверте его кликнув на звездочке для того, что бы вызвать alert,\nзатем кликнете еще раз для проверки того, что alert больше не показывается.');
  }
};
